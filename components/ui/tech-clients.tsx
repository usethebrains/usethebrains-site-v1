        ...
        <section className="w-full py-16 bg-transparent">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="flex flex-col items-center rounded-xl py-8 px-6 shadow-sm hover:shadow-lg transition bg-linear-to-br from-[#09090B] to-[#13131f] border border-[#27272a] hover:border-[#004be0]/30">
