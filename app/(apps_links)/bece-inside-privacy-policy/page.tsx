...
export const metadata: Metadata = {
    ...
    openGraph: {
      title: "Privacy Policy - BECE Inside",
      description: "Read our Privacy Policy to understand how we handle your personal data.",
      url: "https://usethebrains.com/bece-inside-privacy-policy",
    ...
    alternates: {
      canonical: "https://usethebrains.com/bece-inside-privacy-policy",
    },
  };
...
<p>
    Usethebrains built the BECE Inside app as a Free app. This SERVICE is
    provided by Usethebrains at no cost and is intended for use as is.
</p>
<p>
...
<p>
    ...
    Terms and Conditions, which is accessible at BECE Inside unless otherwise
...
<p>
    Link to privacy policy of third party service providers used by the app  We
    want to inform you that whenever you use our Service, in a case of an error
...
<p>
    ...
    information and improve their services. You have the option to either accept
...
<p>
    info@usethebrains.com.
</p>
<p>
    beceinside@usethebrains.com
</p>
<br/>
    </div>
  )
