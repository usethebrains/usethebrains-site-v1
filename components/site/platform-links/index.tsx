  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 border-t border-white/5">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-white mb-4">Explore Our Platform</h2>
        <p className="text-[#7f858e] max-w-2xl mx-auto">Discover all the resources and tools available to help you on your learning journey</p>
      </div>
